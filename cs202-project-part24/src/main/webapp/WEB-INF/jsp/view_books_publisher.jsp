...
<head>
    ...
    #filterDiv h3,#selectBook h3,#viewTable2 h3{
...
<div id="viewTable2">
    ...
    <table>
        ...
        <%
            System.out.println("publisher attribute: "+(String[][]) session.getAttribute("Publisher_books"));
            String[][] data6 = (String[][]) session.getAttribute("Publisher_books");
            if (data6 != null)
            {
                //System.out.println("passed != null");
                for (String[] item : data6)
                {
                    //system.out.println("passed 1st loop");
        %>
        <tr>
            <% for (String temp : item) {
                //System.out.println("passed 2nd loop");
            %>
            <td> <%= temp %></td>
            <%
                }
