...
<head>
    ...
    <style>
        ...
        #viewTable h3,#selectBook h3,#statisticsDiv h3{
            text-transform: uppercase;
            padding-left: 10px;
        }
        #statisticsDiv{
...
<div id="statisticsDiv">
    ...
    <div class="innerFilterDiv">
        <label style="">Which books are borrowed are borrowed the most last 3 months</label>
        <table>
            <tr>
                <th>ISBN</th>
                <th>title</th>
    ...
    <div id="viewTable">
        ...
        <table>
            ...
            <%
                String[][] data = (String[][]) session.getAttribute("mostBorrowingUsers");
                if (data != null)
                {
