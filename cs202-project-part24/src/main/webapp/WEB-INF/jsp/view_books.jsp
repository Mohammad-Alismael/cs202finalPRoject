...
<div id="selectBook">
    ...
    <div id="selectBookInner">
        ...
        <input type="text" name="quantity" placeholder="quantity" style="display:block" disabled/>
...
<%--        <p id="totalPenalty" style="display: none">total penalty: 3434.87</p>--%>
        ...
        <script type="text/javascript">
            ...
            var isnb = document.getElementById("isbnPenalty");
            ...
            function update(){
                ...
                window.location.href = str_url
                <%--if (whichTable.item(whichTable.selectedIndex).innerText == "return books"){--%>
                <%--    --%>
                <%--    totalPenalty.style.display = "block";--%>
                <%--    totalPenalty.innerText =  "penalty : ${penalty}"--%>
            ...
            function checkBook(){
                if (whichTable.item(whichTable.selectedIndex).innerText == "where to add a book"){
                    totalPenalty.style.display = "none";
                    quantitySelect.disabled = true;
                }else if (whichTable.item(whichTable.selectedIndex).innerText == "borrow"){
                    totalPenalty.style.display = "none";
                    quantitySelect.disabled = true;
