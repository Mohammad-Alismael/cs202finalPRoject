...
<%--                <option>jarir4</option>--%>
    ...
    <script type="text/javascript">
        ...
        function addBook() {
            ...
            if (isnb.value == "") {
                alert("you to have to choose a correct ISBN to add a book")
            } else if (whichTable.selectedIndex == 0) {
                alert("You have to select a transaction")
            } else {
                checkBook()
        ...
        function checkBook(){
            //var str_url = '/main_page_user/view_books?isbn=' + isnb.value;
            //window.location.href = str_url

            <%
            String[][] data3 = (String[][]) session.getAttribute("penaltyAndPrice");
            %>
            <%if (data3 != null){%>
            parentTable.getElementsByTagName("tr")[1].getElementsByTagName("td")[0].innerText = "${data3[0][0]}";// title
            parentTable.getElementsByTagName("tr")[1].getElementsByTagName("td")[1].innerText = "${data3[0][1]}";// penalty
            parentTable.getElementsByTagName("tr")[1].getElementsByTagName("td")[2].innerText = "${data3[0][2]}"; //price
                ...
                if (whichTable.item(whichTable.selectedIndex).innerText == "borrow"){
                    ...
                    totalPenalty.innerText =  "total penalty : ${5}"
                    quantitySelect.style.display = "none";
                }
            <%}%>
        }
