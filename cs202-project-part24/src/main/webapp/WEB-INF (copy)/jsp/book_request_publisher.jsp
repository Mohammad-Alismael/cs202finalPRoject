    ...
    function submit(){
        if (cb[0].checked){
            var str_url = '/main_page_publisher/book_request_publisher?ISBN='+
                AddExisting[0].value+'&quantity='+AddExisting[1].value
               ;
        ...
        if (cb[1].checked){
         ...
         var str_url = '/main_page_publisher/book_request_publisher?ISBN='+
                ...
                '&borrow_units='+NoneExisting[6].value+'&sell_units='+NoneExisting[7].value+'&publication_date='+NoneExisting[8].value;
            ;
